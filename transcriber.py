...
def common_options(func):
    options = [
        click.option('-m', '--model', type=click.Choice(
            ...
            default='tiny.en', help='Options for transcription model'),
        ...
        click.option('-s', '--speakers', type=str, help="Supply the speakers for the transcript in 'quotes' and separated by commas"),
        click.option('-c', '--category', type=str, help="Supply the category for the transcript in 'quotes' and separated by commas"),
